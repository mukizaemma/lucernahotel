        ...
        <div class="content">
            ...
            <div class="container-fluid px-4">
                ...
                <ul class="nav mt-10">
                    ...
                    <li class="breadcrumb-item active">Updating <strong> {{$facility->title}}</strong></li>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form class="form" action="{{ route('updateFacility',$facility->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    ...
                                    <div  class="row mt-3">
                                        <div class="col-lg-4 col-sm-12">
                                            ...
                                            <img src="{{ asset('storage/images/facilities/' . $facility->image) }}" alt="" width="120px">
                                        </div>
                                        <div class="col-lg-4 col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6 mb-4">
                                            <div class="card shadow" style="position: relative; overflow: hidden; transition: 0.3s;">
                                                <img src="{{ asset('storage/images/facilities/' . $image->image) }}" 
                                                    class="card-img-top rounded" alt="Blog Image" style="width: 100%; height: auto;">
                                                <button onclick="confirmDelete('{{ route('deleteFacilityImage', $image->id) }}')" 
...
<div class="modal fade" id="newImage">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title">Adding New Image to {{ $facility->title ?? '' }}</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>

        <!-- Modal body -->
        <div class="modal-body">
            <form class="form" action="{{ route('addFacilityImage',['id'=>$facility->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row mb-3">
